...
Most labs are designed to have an individual component and a group component. Failure to
...
capped at **45 FL**. Students affected by inactive group members will be given the option to
complete anything that can be completed by the following lab. Furthermore, the group component is
(usually) only worth a total of 20% for each lab. Three of the labs will have a group component
worth 60% of the lab.
...
* **Extending a project**. This is, by far, the most abitious assignment. Students are given working
  ...
  C++-like, and sometimes simply 'clever' or poorly documented). Students will need to work with
  both parts in order to successfully complete the assignment.
